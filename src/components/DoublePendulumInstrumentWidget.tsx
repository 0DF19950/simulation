...
import { simulateDoublePendulum } from '../utils/doublePendulumEngine';
...
export const DoublePendulumInstrumentWidget: React.FC = () => {
  const result = useMemo(() => simulateDoublePendulum(PARAMS), []);
      ...
      <div className="flex items-center justify-between pb-3 mb-5 border-b border-sage/30">
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono text-xs font-bold text-cream uppercase tracking-wider">
            Double Pendulum — Instrument View
          </span>
        </div>
